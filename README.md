...
┌──(kali㉿kali)-[~/javalab] └─$ java WrapperClassDemo
...
===============OUTPUT EX 7==================
(kali㉿kali)-[~/javalab] └─$ java ThreadProgram
...
=================OUTPUT EX 10=================
──(kali㉿kali)-[~/javalab] └─$ java FileDemo
...
================OUTPUT EX 12==================
──(kali㉿kali)-[~/javalab] └─$ java reservation
